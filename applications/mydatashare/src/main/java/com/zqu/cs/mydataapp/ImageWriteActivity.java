...
import com.zqu.cs.mydataapp.util.DateUtil;
import com.zqu.cs.mydataapp.util.FileUtil;
...
public class ImageWriteActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void initTypeSpinner() {
        ...
        typeAdapter.setDropDownViewResource(R.layout.item_dropdown);    //适配器连接资源
        Spinner sp_married = findViewById(R.id.sp_married); //一个提示框进行选择
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_save) {
            ...
            if (TextUtils.isEmpty(name)) {  //如果有文本框为空，提示
                showToast("请先填写姓名");
                return;
